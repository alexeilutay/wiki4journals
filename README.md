...
Я убежден в том, что возможности Вики-сервисов (Wikipedia, Wikidata и
др.) следует изучать прежде всего для того, чтобы знать “как оно может
быть”. Надеюсь, что после ознакомления с перечисленными в данном
материале возможностями Вики-сервисов, читатели смогут по-новому
