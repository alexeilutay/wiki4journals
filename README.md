...
[РУВИКИ](https://ru.ruwiki.ru/),
[Циклопедии](https://cyclowiki.org/), развернутых на базе ПО
MediaWiki.Ни факт упоминания, ни порядок перечисления этих проектов не
отражают предпочтений автора и не являются рекомендацией к
использованию.
...
ограничениях, касающихся использования перечисленных ресурсов.
Автор не может судить о наличии в упоминаемых онлайн-ресурсах
сведений, которые могут рассматриваться как порочащие или ложные.
Материал не является рекламой и предназначен для половозрелых
благоразумных людей, которые сами смогут решить who is who.
