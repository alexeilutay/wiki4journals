...
Большая часть примеров тематически связана с академическими журналам,
поскольку материал был написан для доклада на 11-ой Международной
научно-практической конференции Ассоциации научных редакторов и
издателей (АНРИ) «Научное издание международного уровня – 2023:
достижения, реалии, перспективы» (23-26 мая, 2023 г.).
...
-   [Интерфейс Quick Statements для редактирования Wikidata с помощью
    текстовых команд](https://quickstatements.toolforge.org/#/)
...
трудолюбивыми [ботами и
энтузиастами](https://www.wikidata.org/wiki/Wikidata:WikiProject_Source_MetaData),
что упрощает их цитирование в статьях Wikipedia. Более того, [крупнейшие
мировые издатели предоставляют бесплатный
доступ](https://wikipedialibrary.wmflabs.org/) к своим полнотекстовым
архивам для опытных редакторов Wikipedia.
...
[Event Data API](https://www.crossref.org/services/event-data/)).
...
др.) должны изучаться для того, чтобы знать “как оно может быть”.
Надеюсь, что после ознакомления с перечисленными в данном материале
возможностями Вики-сервисов, читатели смогут по-новому взглянуть на
практическую ценность любых других онлайн-ресурсов (особенно тех,
которыми предлагается импортозамещать Wikipedia).
