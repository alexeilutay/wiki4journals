...
-   настоящий материал не должен рассматриваться как моё
    согласие/одобрение/неодобрение по отношению к любым утверждениям и
    точкам зрения, опубликованным на перечисленных ресурсах

-   если Вы склонны думать, что какие-то материалы из перечисленных
    ресурсов являются порочащими, ложными, оскорбительными или
    нарушающими чьи-то права, обязательно свяжитесь с правообладателем
    ресурса, правоохранителями, правозащитниками и т.п.
...
прочтение материала ниже, а также за все связанные с этим последствия.
...
> [`http://www.wikiznanie.ru/wikipedia/api.php?action=query&list=exturlusage&euquery=www.kremlin.ru&eunamespace=0&format=json`](http://www.wikiznanie.ru/wikipedia/api.php?action=query&list=exturlusage&euquery=www.kremlin.ru&eunamespace=0&format=json)

**Поиск других статей ресурса, цитирующих выбранную страницу**

> [`http://www.wikiznanie.ru/wikipedia/api.php?action=query&titles=Пихта&prop=linkshere&lhlimit=200&lhnamespace=0&format=json`](http://www.wikiznanie.ru/wikipedia/api.php?action=query&titles=Пихта&prop=linkshere&lhlimit=200&lhnamespace=0&format=json)
...
> [`http://www.wikiznanie.ru/wikipedia/api.php?action=query&titles=%D0%A1%D0%B8%D0%BB%D0%B0%20%D0%A1%D0%B8%D0%B1%D0%B8%D1%80%D0%B8&prop=pageviews&format=json`](http://www.wikiznanie.ru/wikipedia/api.php?action=query&titles=%D0%A1%D0%B8%D0%BB%D0%B0%20%D0%A1%D0%B8%D0%B1%D0%B8%D1%80%D0%B8&prop=pageviews&format=json)
...
> [`https://traditio.wiki/w/api.php?action=query&list=exturlusage&euquery=www.gazprom.ru&eunamespace=0&format=json`](https://traditio.wiki/w/api.php?action=query&list=exturlusage&euquery=www.gazprom.ru&eunamespace=0&format=json)
...
> [`https://traditio.wiki/w/api.php?action=query&titles=Жан-Поль Бельмондо&prop=pageviews&format=json`](https://traditio.wiki/w/api.php?action=query&titles=%D0%96%D0%B0%D0%BD-%D0%9F%D0%BE%D0%BB%D1%8C%20%D0%91%D0%B5%D0%BB%D1%8C%D0%BC%D0%BE%D0%BD%D0%B4%D0%BE&prop=pageviews&format=json)
...
> [`https://ruxpert.ru/api.php?action=parse&page=Мифы_о_России&format=json`](https://ruxpert.ru/api.php?action=parse&page=Мифы_о_России&format=json)
...
> [`https://ruxpert.ru/api.php?action=query&list=exturlusage&euquery=www.gazprom.ru&eunamespace=0&format=json`](https://ruxpert.ru/api.php?action=query&list=exturlusage&euquery=www.gazprom.ru&eunamespace=0&format=json)

**Поиск других статей ресурса, цитирующих выбранную страницу**

> [`https://ruxpert.ru/api.php?action=query&titles=Мифы о России&prop=linkshere&lhlimit=200&lhnamespace=0&format=json`](https://ruxpert.ru/api.php?action=query&titles=%D0%9C%D0%B8%D1%84%D1%8B%20%D0%BE%20%D0%A0%D0%BE%D1%81%D1%81%D0%B8%D0%B8&prop=linkshere&lhlimit=200&lhnamespace=0&format=json)

**Cсылки из статьи на другие статьи ресурса (links) и внешние сайты
(extlinks)**

> [`https://ruxpert.ru/api.php?action=query&titles=Мифы о России&prop=links|extlinks&ellimit=500&elexpandurl=true&format=json`](https://ruxpert.ru/api.php?action=query&titles=%D0%9C%D0%B8%D1%84%D1%8B%20%D0%BE%20%D0%A0%D0%BE%D1%81%D1%81%D0%B8%D0%B8&prop=links%7Cextlinks&ellimit=500&elexpandurl=true&format=json)
...
> [`https://ruxpert.ru/api.php?action=query&titles=%D0%A1%D0%B8%D0%BB%D0%B0%20%D0%A1%D0%B8%D0%B1%D0%B8%D1%80%D0%B8&prop=pageviews&format=json`](https://ruxpert.ru/api.php?action=query&titles=%D0%A1%D0%B8%D0%BB%D0%B0%20%D0%A1%D0%B8%D0%B1%D0%B8%D1%80%D0%B8&prop=pageviews&format=json)
...
читателям тематическое многообразие порталов, доступ к содержимому
которых возможен через API-интерфейс.

#### Научно-образовательные и профессиональные порталы

-   <http://m-protect.ru/wiki/index.php> – Профессиональный
    информационно-аналитический ресурс, посвященный физической химии,
    нанотехнологиям, cупрамолекулярной химии и другим физико-химическим
    направлениям. API: <http://m-protect.ru/wiki/api.php>.
...
-   <https://nlpub.ru> – каталог ресурсов для обработки естественного
    ...
    необходимых для успешного построения систем автоматической обработки
    русского языка). API: <https://nlpub.ru/api.php>.

-   <http://www.machinelearning.ru> – Профессиональный
    информационно-аналитический ресурс, посвященный машинному обучению,
    распознаванию образов и интеллектуальному анализу данных. API:
...
-   <http://wikirtishchevo.shoutwiki.com> – Ртищевская краеведческая
    энциклопедия. API: <http://wikirtishchevo.shoutwiki.com/w/api.php>.
...
-   [http://provizorii.ru](http://provizorii.ru/) – свободный
    энциклопедический интернет-проект на русском языке, посвящённый
    широкой тематике. Первоначально базировался на статьях о филателии.
    API: <http://provizorii.ru/w/api.php>.
...
-   <https://chipwiki.ru> – Chipwiki посвящена ретро- и
    околоретро-творчеству на компьютерах и игровых консолях: музыке,
    пиксель-арту и демосцене. API: <https://chipwiki.ru/api.php>.
...
-   [https://летнийлагерь.рф](https://%D0%BB%D0%B5%D1%82%D0%BD%D0%B8%D0%B9%D0%BB%D0%B0%D0%B3%D0%B5%D1%80%D1%8C.%D1%80%D1%84/)
    ...
    лагерей). API: <a href="http://летнийлагерь.рф/api.php"
    class="uri">http://летнийлагерь.рф/api.php</a>.
...
-   <https://nkvd.memo.ru> – Кадровый состав органов государственной
    безопасности СССР. 1935−1939. API: <https://nkvd.memo.ru/api.php>.
...
-   [https://neolurk.org/](https://neolurk.org/wiki/) – энциклопедия
    мемов, культуры и интернетов. API: <https://neolurk.org/w/api.php>.
...
медиа-культуры. Подавляющее большинство сообществ в списке прекратили
обновляться, не достигнув и 100 статей. Несмотря на непривычный
интерфейс, сайты основаны на Mediawiki, поэтому для обращения к ним
можно использовать вышеописанные запросы.
...
-   [https://science.fandom.com/](https://science.fandom.com/ru/) –
    Викинаука. Свыше 23 тысяч статей, но проект уже несколько лет не
    обновляется. API: <https://science.fandom.com/ru/api.php>.
...
-   <https://texnopedia.miraheze.org> – Технопедия. Свободная
    энциклопедия, посвященная технике, программному обеспечению,
    компьютерам и другим смежным областям науки и технологий. API:
    <https://texnopedia.miraheze.org/w/api.php>.
