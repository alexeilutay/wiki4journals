...
> https://ru.wikipedia.org/api/rest_v1/page/title/Доклады Академии наук
...
> https://ru.wikipedia.org/w/rest.php/v1/page/Доклады%20Академии%20наук/history/counts/edits
> https://ru.wikipedia.org/w/rest.php/v1/page/Доклады%20Академии%20наук/history/counts/edits?from=88695017&to=97918317
...
Сервис поддерживает также формат zotero и несколько других (mediawiki, wikibase). Цитируемый URL включает параметр oldid – идентификатор последней правки на момент цитирования! Обратите внимание на необходимость URL-кодирования гиперссылки страницы Wikipedia. 
