...
- [Интерфейс Quick Statements для редактирования Wikidata с помощью текстовых команд](https://quickstatements.toolforge.org/#/)
...
Сведения о научных изданиях и публикациях непрерывно добавляются в Wikidata см. [раздел Journals в сервисе Mix'n'match](https://mix-n-match.toolforge.org/#/group/journals)  трудолюбивыми [ботами и энтузиастами](https://www.wikidata.org/wiki/Wikidata:WikiProject_Source_MetaData), что упрощает их цитирование в статьях Wikipedia. Более того, [крупнейшие мировые издатели предоставляют бесплатный доступ](https://wikipedialibrary.wmflabs.org/) к своим полнотекстовым архивам для опытных редакторов Wikipedia.

Цитирования статей в Википедии учитываются аналитическими инструментами ([Altmetric](https://www.altmetric.com/solutions/free-tools/bookmarklet/), [Plum Analytics](https://plumanalytics.com/), а также CrossRef (см. [Event Data API](https://www.crossref.org/services/event-data/)).   
